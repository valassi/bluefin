...
%\rfoot{Cross section example XSE ({\tt xsePaper4.bfin})} % ERROR on Ex2_p15...
...
\begin{myverbboxenv}\verb"xsePaper4.bfin"\end{myverbboxenv}
...
\begin{center}
%%%\lstset{breaklines=false,breakatwhitespace=false,numbers=left,basicstyle=\tiny\ttfamily}
%%%\fbox{\lstinputlisting{xsePaper4.bfin}}\\
...
\lstinputlisting{xsePaper4.bfin}
