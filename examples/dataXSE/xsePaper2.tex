...
%\rfoot{Cross section example XSE ({\tt xsePaper2.bfin})} % ERROR on Ex2_p15...
...
\begin{myverbboxenv}\verb"xsePaper2.bfin"\end{myverbboxenv}
...
\begin{center}
%%%\lstset{breaklines=false,breakatwhitespace=false,numbers=left,basicstyle=\tiny\ttfamily}
%%%\fbox{\lstinputlisting{xsePaper2.bfin}}\\
...
\lstinputlisting{xsePaper2.bfin}
