...
%\rfoot{Cross section example XSE ({\tt xsePaper3.bfin})} % ERROR on Ex2_p15...
...
\begin{myverbboxenv}\verb"xsePaper3.bfin"\end{myverbboxenv}
...
\begin{center}
%%%\lstset{breaklines=false,breakatwhitespace=false,numbers=left,basicstyle=\tiny\ttfamily}
%%%\fbox{\lstinputlisting{xsePaper3.bfin}}\\
...
\lstinputlisting{xsePaper3.bfin}
