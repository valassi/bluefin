...
\addtolength{\paperwidth}{42.20096pt} % NEW 0.04
\addtolength{\paperheight}{29.9399pt} % NEW 0.04
\usepackage{fancyhdr}
...
\addtolength{\textwidth}{42.20096pt} % NEW 0.04
\addtolength{\textheight}{29.9399pt} % NEW 0.04
...
\addtolength{\textheight}{-4mm} % Make space for extra footer
...
\addtolength{\footskip}{4mm} % Make space for extra footer
...
\cfoot{\thepage\\{\raisebox{1.4cm}[0pt][0pt]{\color{red}\em WARNING! This is an example where inputs are taken from Table 4 in CMS PAS TOP-12-001. The output results differ because of rounding errors in those inputs.}}}
%\rfoot{LHC top mass combination 2012 ({\tt lhc2012.bfin})} % ERROR on Ex2_p15...
...
\begin{myverbboxenv}\verb"lhc2012.bfin"\end{myverbboxenv}
\rfoot{LHC top mass combination 2012 (\usebox\myverbsavebox)}
...
\begin{center}
%%%\lstset{breaklines=false,breakatwhitespace=false,numbers=left,basicstyle=\tiny\ttfamily}
%%%\fbox{\lstinputlisting{lhc2012.bfin}}\\
