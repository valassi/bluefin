...
\lfoot{\raisebox{-0.35cm}{\includegraphics[height=1cm]{BlueFinLogo.jpg}}\hspace*{3mm}{\sc BlueFin 01.00.05}}
%%%{\it\tiny (BLUE Fisher Information aNalysis)}
%%%\cfoot{} % Use default (\thepage)
\cfoot{\thepage\\{\raisebox{1.4cm}[0pt][0pt]{\color{red}\em }}}
%\rfoot{LHC top mass combination 2012 ({\tt lhc2012bJESonly.bfin})} % ERROR on Ex2_p15...
...
\begin{myverbboxenv}\verb"lhc2012bJESonly.bfin"\end{myverbboxenv}
...
\begin{center}
%%%\lstset{breaklines=false,breakatwhitespace=false,numbers=left,basicstyle=\tiny\ttfamily}
%%%\fbox{\lstinputlisting{lhc2012bJESonly.bfin}}\\
...
\lstinputlisting{lhc2012bJESonly.bfin}
