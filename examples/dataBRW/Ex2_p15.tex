...
%\rfoot{W branching ratio Ex2p15 ({\tt Ex2_p15.bfin})} % ERROR on Ex2_p15...
...
\begin{myverbboxenv}\verb"Ex2_p15.bfin"\end{myverbboxenv}
\rfoot{W branching ratio Ex2p15 (\usebox\myverbsavebox)}
...
\begin{center}
%%%\lstset{breaklines=false,breakatwhitespace=false,numbers=left,basicstyle=\tiny\ttfamily}
%%%\fbox{\lstinputlisting{Ex2_p15.bfin}}\\
