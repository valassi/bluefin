...
\addtolength{\paperwidth}{89.01694pt} % NEW 0.04
\addtolength{\paperheight}{63.1539pt} % NEW 0.04
\usepackage{fancyhdr}
...
\addtolength{\textwidth}{89.01694pt} % NEW 0.04
\addtolength{\textheight}{63.1539pt} % NEW 0.04
...
\cfoot{\thepage\\{\raisebox{1.4cm}[0pt][0pt]{\color{red}\em LEP Combination for the Summer 2001 Conferences (http://lepewwg.web.cern.ch/LEPEWWG/lepww/4f/Summer01). The output results may differ because of rounding errors.}}}
%\rfoot{LEP2 WW cross sections ({\tt sww.bfin})} % ERROR on Ex2_p15...
...
\begin{myverbboxenv}\verb"sww.bfin"\end{myverbboxenv}
\rfoot{LEP2 WW cross sections (\usebox\myverbsavebox)}
