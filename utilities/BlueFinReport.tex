...
\addtolength{\paperwidth}{BFWADDPTpt} % NEW 0.04
\addtolength{\paperheight}{BFHADDPTpt} % NEW 0.04
\usepackage{fancyhdr}
...
\addtolength{\textwidth}{BFWADDPTpt} % NEW 0.04
\addtolength{\textheight}{BFHADDPTpt} % NEW 0.04
...
\addtolength{\textheight}{-BFEXTRAFOOTMM} % Make space for extra footer
...
\addtolength{\footskip}{BFEXTRAFOOTMM} % Make space for extra footer
...
\lfoot{\raisebox{-0.35cm}{\includegraphics[height=1cm]{BlueFinLogo.jpg}}\hspace*{3mm}{\sc BlueFin BFVERS}}
%%%{\it\tiny (BLUE Fisher Information aNalysis)}
%%%\cfoot{} % Use default (\thepage)
\cfoot{\thepage\\{\raisebox{1.4cm}[0pt][0pt]{\color{red}\em BFEXTRAFOOTER}}}
%\rfoot{BFMYCOMBNAME ({\tt BFMYFILENAMEIN})} % ERROR on Ex2_p15...
...
\begin{myverbboxenv}\verb"BFMYFILENAMEIN"\end{myverbboxenv}
\rfoot{BFMYCOMBNAME (\usebox\myverbsavebox)}
...
\begin{center}
%%%\lstset{breaklines=false,breakatwhitespace=false,numbers=left,basicstyle=\tiny\ttfamily}
%%%\fbox{\lstinputlisting{BFMYFILENAMEIN}}\\
...
\lstinputlisting{BFMYFILENAMEIN}
